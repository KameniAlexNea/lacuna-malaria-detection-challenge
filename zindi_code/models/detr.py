...
class DetrAttention(nn.Module):
    ...
    def with_pos_embed(
        self, tensor: torch.Tensor, object_queries: Optional[Tensor], **kwargs
    ):
    ...
    def forward(
        ...
        **kwargs,
        ...
        key_value_position_embeddings = kwargs.pop(
        ...
        if (
            key_value_position_embeddings is not None
            and spatial_position_embeddings is not None
        ):
            raise ValueError(
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if self.config.auxiliary_loss:
                ...
                auxiliary_outputs = self.detr._set_aux_loss(
